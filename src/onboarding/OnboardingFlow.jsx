        ...
        <div className="px-4 pt-[max(1rem,env(safe-area-inset-top))] pb-2">
          {isLesson && (
            <div className="flex items-center gap-3">
              <button
                onClick={goBack}
                className="p-2 -ml-2 text-slate-400 hover:text-slate-700 rounded-full transition-colors shrink-0"
                aria-label="Back"
              >
        ...
        <AnimatePresence mode="wait">
          ...
          {step === COMPLETE_STEP && (
            ...
            >
              ...
              <p className="text-sm text-slate-500 max-w-[280px]">
                Point your camera at the court and DinkAI will start watching.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
